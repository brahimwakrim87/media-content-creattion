...
#[ApiResource(
    operations: [
        new Get(
            ...
            security: "is_granted('ROLE_USER') and object.getCampaignObject().getCampaign().hasAccess(user)",
        ),
        new GetCollection(
        ...
        new Patch(
            ...
            security: "is_granted('ROLE_USER') and object.getCampaignObject().getCampaign().canEdit(user)",
        ),
        new Delete(
